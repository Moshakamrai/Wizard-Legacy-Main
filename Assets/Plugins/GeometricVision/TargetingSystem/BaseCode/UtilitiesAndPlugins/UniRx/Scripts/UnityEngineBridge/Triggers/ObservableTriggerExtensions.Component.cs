...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<int>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<Unit>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<Collision2D>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<Collision>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Return(Unit.Default); // send destroy message
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<Collider2D>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<Collider>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<BaseEventData>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<AxisEventData>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<PointerEventData>();
        ...
        {
            if (component == null || component.gameObject == null) return Scripts.Observable.Empty<GameObject>();
