...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge
{
    ...
    public static partial class Scheduler
    {
        ...
        {
            Schedulers.Scheduler.DefaultSchedulers.ConstantTimeOperations = Schedulers.Scheduler.Immediate;
            Schedulers.Scheduler.DefaultSchedulers.TailRecursion = Schedulers.Scheduler.Immediate;
            Schedulers.Scheduler.DefaultSchedulers.Iteration = Schedulers.Scheduler.CurrentThread;
            Schedulers.Scheduler.DefaultSchedulers.TimeBasedOperations = MainThread;
            Schedulers.Scheduler.DefaultSchedulers.AsyncConversions = Schedulers.Scheduler.ThreadPool;
        }
#endif
        ...
        class MainThreadScheduler : IScheduler, ISchedulerPeriodic, ISchedulerQueueing
        {
            ...
            {
                get { return Schedulers.Scheduler.Now; }
            }
            ...
            public IDisposable Schedule(Action action)
            {
                ...
                MainThreadDispatcher.Post(this.scheduleAction, Tuple.Create(d, action));
                return d;
            }
            ...
            {
                var d = new BooleanDisposable();
                var time = Schedulers.Scheduler.Normalize(dueTime);

                MainThreadDispatcher.SendStartCoroutine(this.DelayAction(time, action, d));
            ...
            {
                var d = new BooleanDisposable();
                var time = Schedulers.Scheduler.Normalize(period);

                MainThreadDispatcher.SendStartCoroutine(this.PeriodicAction(time, action, d));
        ...
        class FixedUpdateMainThreadScheduler : IScheduler, ISchedulerPeriodic, ISchedulerQueueing
        {
            ...
            public IDisposable Schedule(TimeSpan dueTime, Action action)
            {
                ...
                MainThreadDispatcher.StartFixedUpdateMicroCoroutine(this.DelayAction(time, action, d));
            ...
            public IDisposable SchedulePeriodic(TimeSpan period, Action action)
            {
                ...
                MainThreadDispatcher.StartFixedUpdateMicroCoroutine(this.PeriodicAction(time, action, d));
            ...
            public void ScheduleQueueing<T>(ICancelable cancel, T state, Action<T> action)
            {
                MainThreadDispatcher.StartFixedUpdateMicroCoroutine(this.ImmediateAction(state, action, cancel));
            }
        }
        ...
        class EndOfFrameMainThreadScheduler : IScheduler, ISchedulerPeriodic, ISchedulerQueueing
        {
            ...
            public IDisposable Schedule(TimeSpan dueTime, Action action)
            {
                ...
                MainThreadDispatcher.StartEndOfFrameMicroCoroutine(this.DelayAction(time, action, d));
            ...
            public IDisposable SchedulePeriodic(TimeSpan period, Action action)
            {
                ...
                MainThreadDispatcher.StartEndOfFrameMicroCoroutine(this.PeriodicAction(time, action, d));
            ...
            public void ScheduleQueueing<T>(ICancelable cancel, T state, Action<T> action)
            {
                MainThreadDispatcher.StartEndOfFrameMicroCoroutine(this.ImmediateAction(state, action, cancel));
            }
        }
    }
}