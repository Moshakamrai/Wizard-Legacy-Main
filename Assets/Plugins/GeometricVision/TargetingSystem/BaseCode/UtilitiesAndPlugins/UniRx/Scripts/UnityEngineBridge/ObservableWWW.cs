...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge
{
    ...
    using Hash = global::System.Collections.Generic.Dictionary<string, string>;
    using HashEntry = global::System.Collections.Generic.KeyValuePair<string, string>;
#endif
    ...
    public class WWWErrorException : Exception
    {
        ...
        public global::System.Net.HttpStatusCode StatusCode { get; private set; }
        ...
        public WWWErrorException(WWW www, string text)
        {
            ...
            var splitted = this.RawErrorMessage.Split(' ', ':');
            if (splitted.Length != 0)
            {
                ...
                if (int.TryParse(splitted[0], out statusCode))
                {
                    ...
                    this.StatusCode = (global::System.Net.HttpStatusCode)statusCode;
                }
            }
        }
