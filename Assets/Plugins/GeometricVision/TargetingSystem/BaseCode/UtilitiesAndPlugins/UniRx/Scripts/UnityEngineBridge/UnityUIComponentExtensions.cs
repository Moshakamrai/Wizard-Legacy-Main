...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge
{
    public static partial class UnityUIComponentExtensions
    {
        ...
        public static IObservable<bool> OnValueChangedAsObservable(this Toggle toggle)
        {
            ...
            return Scripts.Observable.CreateWithState<bool, Toggle>(toggle, (t, observer) =>
            {
        ...
        {
            return Scripts.Observable.CreateWithState<float, Scrollbar>(scrollbar, (s, observer) =>
            {
        ...
        {
            return Scripts.Observable.CreateWithState<Vector2, ScrollRect>(scrollRect, (s, observer) =>
            {
        ...
        {
            return Scripts.Observable.CreateWithState<float, Slider>(slider, (s, observer) =>
            {
                observer.OnNext(s.value);
                return s.onValueChanged.AsObservable().Subscribe(observer);
            });
        ...
        {
            return Scripts.Observable.CreateWithState<string, InputField>(inputField, (i, observer) =>
            {
                observer.OnNext(i.text);
        ...
        {
            return Scripts.Observable.CreateWithState<int, Dropdown>(dropdown, (d, observer) =>
            {
