...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge.Triggers
{
    ...
    public static partial class ObservableTriggerExtensions
    {
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<int>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<Unit>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<Collision2D>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<Collision>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Return(Unit.Default); // send destroy message
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<Collider2D>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<Collider>();
        ...
        {
            if (gameObject == null) return Scripts.Observable.Empty<GameObject>();
