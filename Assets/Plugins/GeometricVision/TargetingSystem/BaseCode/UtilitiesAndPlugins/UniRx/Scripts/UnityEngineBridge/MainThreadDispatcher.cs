...
namespace Plugins.GeometricVision.TargetingSystem.Code.UtilitiesAndPlugins.UniRx.Scripts.UnityEngineBridge
{
    public sealed class MainThreadDispatcher : MonoBehaviour
    {
        ...
        class EditorThreadDispatcher
        {
            ...
            {
                this.editorQueueWorker.Enqueue(action, state);
            }
            ...
            {
                this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(routine), null);
            }

            void Update()
            {
                this.editorQueueWorker.ExecuteAll(x => Debug.LogException(x));
            }
...
#pragma warning disable CS0618
                    ...
                    {
                        var www = (WWW)current;
                        this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(this.UnwrapWaitWWW(www, routine)), null);
                        return;
                    }
#if UNITY_2018_3_OR_NEWER
#pragma warning restore CS0618
                    ...
                    else if (type == typeof(AsyncOperation))
                    {
                        ...
                        this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(this.UnwrapWaitAsyncOperation(asyncOperation, routine)), null);
                        return;
                    }
                    else if (type == typeof(WaitForSeconds))
                    {
                        ...
                        this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(this.UnwrapWaitForSeconds(second, routine)), null);
                        return;
                    }
                    ...
                    else if (current is IEnumerator)
                    {
                        ...
                        this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(this.UnwrapEnumerator(enumerator, routine)), null);
                        return;
                    }
#endif

                    ENQUEUE:
                    this.editorQueueWorker.Enqueue(_ => this.ConsumeEnumerator(routine), null); // next update
                }
            }
...
#pragma warning disable CS0618
            ...
            IEnumerator UnwrapWaitWWW(WWW www, IEnumerator continuation)
            {
                ...
                this.ConsumeEnumerator(continuation);
            }
#if UNITY_2018_3_OR_NEWER
#pragma warning restore CS0618
#endif
        ...
        void Awake()
        {
            if (instance == null)
            {
                ...
                this.updateMicroCoroutine = new MicroCoroutine(ex => this.unhandledExceptionCallback(ex));
                this.fixedUpdateMicroCoroutine = new MicroCoroutine(ex => this.unhandledExceptionCallback(ex));
                this.endOfFrameMicroCoroutine = new MicroCoroutine(ex => this.unhandledExceptionCallback(ex));

                StartCoroutine(this.RunUpdateMicroCoroutine());
                StartCoroutine(this.RunFixedUpdateMicroCoroutine());
                StartCoroutine(this.RunEndOfFrameMicroCoroutine());
        ...
        void LateUpdate()
        {
            if (this.lateUpdate != null) this.lateUpdate.OnNext(Unit.Default);
        }
        ...
        {
            if (this.onApplicationFocus != null) this.onApplicationFocus.OnNext(focus);
        }
        ...
        {
            if (this.onApplicationPause != null) this.onApplicationPause.OnNext(pause);
        }
        ...
        {
            isQuitting = true;
            if (this.onApplicationQuit != null) this.onApplicationQuit.OnNext(Unit.Default);
        }
